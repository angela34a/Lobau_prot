# function from http://freerangestats.info/blog/2016/08/18/dualaxes 
...
dualplot(y1= lobau_data_combined[which(lobau_data_combined$well_id=="D15" & 
                                   lobau_data_combined$sample_type == "pumped_groundwater"),]$doc_mg_L,
         y2 = lobau_data_combined[which(lobau_data_combined$well_id=="D15" & 
                                          lobau_data_combined$sample_type == "pumped_groundwater"),]$pH,
         x1 = rownames(lobau_data_combined[which(lobau_data_combined$well_id=="D15" & 
                                         lobau_data_combined$sample_type == "pumped_groundwater"),])   )


# not able to group by site
